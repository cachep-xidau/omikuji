...
const StatusBar = ({ light = false, showDynamicIsland = false }) => {
  ...
  // Dynamic Island component inline
  const DynamicIslandElement = () => (
  ...
  if (showDynamicIsland) {
    // iPhone-style layout: Time | Dynamic Island | Icons
    return (
      <div className="w-full relative z-50">
        {/* Dynamic Island - Absolute top center */}
        <div className="absolute left-1/2 -translate-x-1/2 top-[12px] z-[60]">
          <DynamicIslandElement />
        </div>

        {/* Status bar content - aligned with Dynamic Island center */}
        <div className="flex items-center justify-between px-6 pt-[22px] pb-2">
          {/* Left: Time */}
          <span className={`text-sm font-semibold ${textColor} font-sans tracking-wide`}>
            {currentTime}
          </span>
  ...
  // Default layout without Dynamic Island
  return (
    <div className="w-full flex justify-between items-center px-6 pt-3 pb-2 z-50">
